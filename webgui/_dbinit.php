...
$db->query('CREATE TABLE IF NOT EXISTS history(id INT NOT NULL auto_increment PRIMARY KEY, time INT NOT NULL, url TEXT NOT NULL, title TEXT DEFAULT NULL) DEFAULT CHARSET = utf8mb4');
